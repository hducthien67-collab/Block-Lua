...
export const ROBLOX_CLASSES: RobloxClass[] = [
  ...
  { name: 'TestService', category: 'Services', icon: 'CheckCircle', color: '#9E9E9E' },
  { name: 'PhysicsService', category: 'Services', icon: 'Activity', color: '#607D8B' },
  { name: 'CollectionService', category: 'Services', icon: 'Layers', color: '#FF9800' },
  { name: 'RunService', category: 'Services', icon: 'Play', color: '#4CAF50' },
  { name: 'HttpService', category: 'Services', icon: 'Globe', color: '#2196F3' },
  { name: 'TweenService', category: 'Services', icon: 'Move', color: '#9C27B0' },
...
export const OBJECT_CATEGORIES = [
  ...
  { name: 'Chưa được phân loại', classes: ROBLOX_CLASSES.filter(c => ['Physics', 'PostProcessing', 'Media', 'System'].includes(c.category)).map(c => c.name) },
  { name: 'Dịch Vụ (Services)', classes: ROBLOX_CLASSES.filter(c => c.category === 'Services').map(c => c.name) },
