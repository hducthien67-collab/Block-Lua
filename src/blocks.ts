...
export const patchFlyoutAnimations = () => {
...
export const defineCustomBlocks = () => {
  ...
  Blockly.Blocks['instance_wait_for_child'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("wait for child");
      this.appendValueInput("NAME").setCheck("String");
      this.setOutput(true, null);
      this.setColour(getCategoryColor('World'));
      this.setInputsInline(true);
  ...
  Blockly.Blocks['instance_find_first_child'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("find first child");
      this.appendValueInput("NAME").setCheck("String");
      this.setOutput(true, null);
      this.setColour(getCategoryColor('World'));
      this.setInputsInline(true);
  ...
  Blockly.Blocks['instance_get_children'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("get children");
      this.setOutput(true, "Array");
      this.setColour(getCategoryColor('World'));
      this.setInputsInline(true);
    }
  ...
  Blockly.Blocks['instance_get_descendants'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("get descendants");
      this.setOutput(true, "Array");
      this.setColour(getCategoryColor('World'));
      this.setInputsInline(true);
    }
  ...
  Blockly.Blocks['instance_child_added'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("child added");
      this.appendDummyInput().appendField(createVarLabel("var. _child", getCategoryColor('World')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('World'));
  ...
  Blockly.Blocks['instance_child_removed'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("child removed");
      this.appendDummyInput().appendField(createVarLabel("var. _child", getCategoryColor('World')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['instance_descendant_added'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("descendant added");
      this.appendDummyInput().appendField(createVarLabel("var. _descendant", getCategoryColor('World')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('World'));
  ...
  Blockly.Blocks['instance_descendant_removing'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("descendant removing");
      this.appendDummyInput().appendField(createVarLabel("var. _descendant", getCategoryColor('World')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['instance_is_a'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null);
      this.appendDummyInput().appendField("is a")
          .appendField(new Blockly.FieldTextInput("Part"), "CLASS");
      this.setOutput(true, "Boolean");
      this.setColour(getCategoryColor('World'));
      this.setInputsInline(true);
  ...
  Blockly.Blocks['server_fired_by_client'] = {
    init: function() {
      this.appendDummyInput().appendField("on server event fired (by client)");
      this.appendDummyInput().appendField(createVarLabel("var. player", getCategoryColor('Server')), "PLAYER_LABEL");
      this.appendDummyInput().appendField(createVarLabel("var. data", getCategoryColor('Server')), "DATA_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['server_fire_all_clients'] = {
    init: function() {
      this.appendDummyInput().appendField("fire all clients with data:");
  ...
  Blockly.Blocks['leaderstats_create_number'] = {
    init: function() {
      this.appendDummyInput().appendField("create leaderstat (number) named:");
      this.appendValueInput("NAME").setCheck("String");
      this.appendDummyInput().appendField("for player:");
      this.appendValueInput("PLAYER").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['leaderstats_create_string'] = {
    init: function() {
      this.appendDummyInput().appendField("create leaderstat (string) named:");
      this.appendValueInput("NAME").setCheck("String");
      this.appendDummyInput().appendField("for player:");
      this.appendValueInput("PLAYER").setCheck(null);
      this.setPreviousStatement(true, null);
  ...
  Blockly.Blocks['leaderstats_enable'] = {
    init: function() {
      this.appendDummyInput().appendField("enable leaderstats for player:");
      this.appendValueInput("PLAYER").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Leaderstats'));
  ...
  Blockly.Blocks['leaderstats_get'] = {
    init: function() {
      this.appendDummyInput().appendField("get leaderstat");
      this.appendValueInput("NAME").setCheck("String");
      this.appendDummyInput().appendField("of player:");
      this.appendValueInput("PLAYER").setCheck(null);
      this.setOutput(true, null);
      this.setColour(getCategoryColor('Leaderstats'));
      this.setInputsInline(true);
  ...
  Blockly.Blocks['leaderstats_set'] = {
    init: function() {
      this.appendDummyInput().appendField("set leaderstat");
      this.appendValueInput("NAME").setCheck("String");
      this.appendDummyInput().appendField("of player:");
      this.appendValueInput("PLAYER").setCheck(null);
      this.appendDummyInput().appendField("to");
  ...
  Blockly.Blocks['functions_define_global'] = {
    init: function() {
      this.appendDummyInput().appendField("define global function")
          .appendField(new Blockly.FieldTextInput("myGlobalFunction"), "NAME");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Functions'));
  ...
  Blockly.Blocks['datastore_setup'] = {
    init: function() {
      this.appendDummyInput().appendField("setup datastore named:")
          .appendField(new Blockly.FieldTextInput("PlayerData"), "NAME");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['datastore_instance'] = {
    init: function() {
      this.appendDummyInput().appendField("get datastore:")
          .appendField(new Blockly.FieldTextInput("PlayerData"), "NAME");
      this.setOutput(true, null);
      this.setColour(getCategoryColor('Datastore'));
    }
  ...
  Blockly.Blocks['datastore_use'] = {
    init: function() {
      this.appendDummyInput().appendField("with datastore:");
      this.appendValueInput("DATASTORE").setCheck(null);
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Datastore'));
  ...
  Blockly.Blocks['datastore_get'] = {
    init: function() {
      this.appendDummyInput().appendField("get data for key:");
      this.appendValueInput("KEY").setCheck("String");
      this.appendDummyInput().appendField(createVarLabel("var. data", getCategoryColor('Datastore')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Datastore'));
  ...
  Blockly.Blocks['datastore_save'] = {
    init: function() {
      ...
      this.appendValueInput("VALUE").setCheck(null);
      this.appendDummyInput().appendField("for key:");
      this.appendValueInput("KEY").setCheck("String");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Datastore'));
  ...
  Blockly.Blocks['input_key_pressed'] = {
    init: function() {
      this.appendDummyInput().appendField("on key pressed")
          .appendField(new Blockly.FieldTextInput("e"), "KEY");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_key_released'] = {
    init: function() {
      this.appendDummyInput().appendField("on key released")
          .appendField(new Blockly.FieldTextInput("e"), "KEY");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_mouse_button_down'] = {
    init: function() {
      this.appendDummyInput().appendField("on mouse button down")
          .appendField(new Blockly.FieldDropdown([["Left", "0"], ["Right", "1"], ["Middle", "2"]]), "BUTTON");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Input'));
  ...
  Blockly.Blocks['input_mouse_button_up'] = {
    init: function() {
      this.appendDummyInput().appendField("on mouse button up")
          .appendField(new Blockly.FieldDropdown([["Left", "0"], ["Right", "1"], ["Middle", "2"]]), "BUTTON");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_mouse_move'] = {
    init: function() {
      this.appendDummyInput().appendField("on mouse move");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Input'));
  ...
  Blockly.Blocks['input_is_key_down'] = {
    init: function() {
      this.appendDummyInput().appendField("is key down")
          .appendField(new Blockly.FieldTextInput("e"), "KEY");
      this.setOutput(true, "Boolean");
      this.setColour(getCategoryColor('Input'));
    }
  ...
  Blockly.Blocks['input_get_keys_pressed'] = {
    init: function() {
      this.appendDummyInput().appendField("get keys pressed");
      this.setOutput(true, "Array");
      this.setColour(getCategoryColor('Input'));
    }
  };
  ...
  Blockly.Blocks['input_touch_started'] = {
    init: function() {
      this.appendDummyInput().appendField("on touch started");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_touch_ended'] = {
    init: function() {
      this.appendDummyInput().appendField("on touch ended");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_touch_moved'] = {
    init: function() {
      this.appendDummyInput().appendField("on touch moved");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_gamepad_button_pressed'] = {
    init: function() {
      this.appendDummyInput().appendField("on gamepad button pressed");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_gamepad_button_released'] = {
    init: function() {
      this.appendDummyInput().appendField("on gamepad button released");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_began'] = {
    init: function() {
      this.appendDummyInput().appendField("on input began");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_ended'] = {
    init: function() {
      this.appendDummyInput().appendField("on input ended");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_changed'] = {
    init: function() {
      this.appendDummyInput().appendField("on input changed");
      this.appendDummyInput().appendField(createVarLabel("var. _input", getCategoryColor('Input')), "VAR_LABEL");
      this.appendStatementInput("DO").setCheck(null);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  Blockly.Blocks['input_lock_mouse'] = {
    init: function() {
      this.appendDummyInput().appendField("lock mouse");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Input'));
    }
  ...
  Blockly.Blocks['input_unlock_mouse'] = {
    init: function() {
      this.appendDummyInput().appendField("unlock mouse");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Input'));
    }
  ...
  Blockly.Blocks['input_set_mouse_icon'] = {
    init: function() {
      this.appendValueInput("ICON").setCheck("String").appendField("set mouse icon to");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Input'));
    }
  ...
  Blockly.Blocks['effects_emit'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null).appendField("emit from");
  ...
  Blockly.Blocks['effects_enable'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null).appendField("enable effect on");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Effects'));
    }
  ...
  Blockly.Blocks['effects_disable'] = {
    init: function() {
      this.appendValueInput("INSTANCE").setCheck(null).appendField("disable effect on");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Effects'));
    }
  ...
  Blockly.Blocks['effects_spawn'] = {
    init: function() {
      this.appendDummyInput().appendField("spawn")
          .appendField(new Blockly.FieldTextInput("Explosion"), "CLASS");
      this.appendValueInput("POSITION").setCheck(null).appendField("at position");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(getCategoryColor('Effects'));
      this.setInputsInline(true);
  ...
  Blockly.Blocks['client_touch_position'] = {
    init: function() {
      this.appendDummyInput().appendField("touch position");
      this.appendValueInput("TOUCH").setCheck(null);
      this.setOutput(true, null);
      this.setColour(getCategoryColor('Input'));
      this.setInputsInline(true);
    }
